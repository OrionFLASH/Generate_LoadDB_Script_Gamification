...
def main():
    """Основная функция для обработки JSON данных Reward"""
    ...
    input_file = os.path.join(input_dir, "reward_response.json")
    output_file = os.path.join(output_dir, "reward_data.xlsx")
