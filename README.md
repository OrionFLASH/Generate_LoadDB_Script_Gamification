...
- **BANK_groupId** - ID группы для категории BANK (целое число)
- **BANK_placeInRating** - место в рейтинге для категории BANK (целое число)
- **BANK_ratingCategoryName** - название категории рейтинга для BANK
- **TB_groupId** - ID группы для категории TB (целое число)
- **TB_placeInRating** - место в рейтинге для категории TB (целое число)
- **TB_ratingCategoryName** - название категории рейтинга для TB
- **GOSB_groupId** - ID группы для категории GOSB (целое число)
- **GOSB_placeInRating** - место в рейтинге для категории GOSB (целое число)
- **GOSB_ratingCategoryName** - название категории рейтинга для GOSB

**Примечание:** Поля `groupId` и `placeInRating` автоматически преобразуются в целые числа и сохраняются в Excel в числовом формате для корректной сортировки и фильтрации.
...
- Добавлено преобразование `groupId` и `placeInRating` в целые числа
- Числовые значения сохраняются в Excel в числовом формате
