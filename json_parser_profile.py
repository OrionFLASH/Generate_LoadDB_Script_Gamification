...
# -*- coding: utf-8 -*-
"""
Индивидуальный парсер для обработки JSON данных PROFILE
Автор: OrionFLASH
Описание: Специализированный скрипт для обработки данных профилей сотрудников.
...
def main():
    """
    Основная функция для обработки данных PROFILE
    
    Загружает JSON файл с данными профилей сотрудников, разворачивает
    ...
    input_file = os.path.join(input_dir, "profile_response.json")  # Входной JSON файл
    output_file = os.path.join(output_dir, "profile_data.xlsx")    # Выходной Excel файл
    
    # Создание процессора с именем "profile" и уровнем логирования DEBUG
