...
def main():
    """Основная функция для обработки JSON данных LeadersForAdmin"""
    ...
    input_file = os.path.join(input_dir, "leaders_for_admin_response.json")
    output_file = os.path.join(output_dir, "leaders_for_admin_data.xlsx")
